package work.onss.hero.data.di
...
import work.onss.hero.data.repository.score.ScoreApi
import work.onss.hero.data.repository.site.SiteApi
...
object NetworkModule {
    ...
    fun provideRetrofit(okHttpClient: OkHttpClient): Retrofit {
        ...
        return Retrofit.Builder()
            .baseUrl("http://192.168.0.4:8040/hero/")
            .client(okHttpClient)
