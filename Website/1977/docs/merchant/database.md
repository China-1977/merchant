...
### 数据模型
![数据模型](../../public/images/1977_database.png)
...
alter table master.store  owner to postgres;
...
alter table master.account owner to postgres;
...
comment on column master.product.area_code is '区编号';
...
alter table master.product owner to postgres;
...
alter table master.cart owner to postgres;
...
alter table master.prefer owner to postgres;
...
alter table master.score owner to postgres;
...
alter table master.store_customer owner to postgres;
...
comment on table master.mapping_member is '管理员与平台资源关联';
comment on column master.mapping_member.member_id is '管理员ID';
comment on column master.mapping_member.mapping_id is '平台资源ID';
alter table master.mapping_member owner to postgres;
