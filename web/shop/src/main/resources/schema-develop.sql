...
(
    ...
    license_number varchar(20) not null  constraint uk_store_license_number unique,
...
alter table develop.store  owner to postgres;

create table if not exists develop.customer
(
    id          bigserial primary key,
    phone       char(11) not null constraint uk_customer_phone unique,
...
alter table develop.customer owner to postgres;


create table if not exists develop.account
(
    id          bigserial primary key,
    phone       char(11) not null constraint uk_account_phone unique,
    session_key varchar(50),
    sp_appid    varchar(50),
    sp_openid   varchar(50),
    sub_appid   varchar(50),
...
alter table develop.account owner to postgres;
...
alter table develop.address owner to postgres;
...
(
    ...
    stock        integer       not null default 0 constraint product_stock_check check (stock >= 0),
    max          integer       not null default 1 constraint product_max_check check (max >= 1),
    min          integer       not null default 1 constraint product_min_check check (min >= 1),
    vid          varchar(50),
    description  varchar(255),
    label        varchar(50),
    pictures     text[],
...
alter table develop.product owner to postgres;
...
(
    ...
    num     integer not null default 1 constraint cart_num_check check (num >= 1),
    insert_time  timestamp     not null default current_timestamp,
    update_time  timestamp     not null default current_timestamp
);
...
alter table develop.prefer owner to postgres;
...
(
    ...
    out_trade_no       char(19)     not null constraint uk_score_out_trade_no unique,
    pay_time           timestamp,
...
alter table develop.score owner to postgres;
...
create table if not exists develop.resource
(
    id          bigserial primary key,
...
comment on table develop.resource is '服务资源';
comment on column develop.resource.context_path is '服务名称';
comment on column develop.resource.name is '名称';
comment on column develop.resource.type is '类型';
comment on column develop.resource.value is '路径';
comment on column develop.resource.insert_time        is '创建时间';
comment on column develop.resource.update_time        is '更新时间';
alter table develop.resource owner to postgres;

create table if not exists develop.resource_customer
(
    id          bigserial primary key,
    customer_id bigint not null,
...
comment on table develop.resource_customer is '营业员与服务资源关联';
comment on column develop.resource_customer.customer_id is '营业员ID';
comment on column develop.resource_customer.resource_id is '服务资源ID';
comment on column develop.resource_customer.store_id is '商户ID';
alter table develop.resource_customer owner to postgres;
...
alter table develop.store_customer owner to postgres;

create table if not exists develop.member
(
    id             bigserial primary key,
    phone          char(11)    not null constraint uk_member_phone unique,
    name           varchar(20) not null,
    id_card        char(18)    not null constraint uk_member_id_card unique,
...
alter table develop.member owner to postgres;

create table if not exists develop.mapping
(
    id          bigserial primary key,
    context_path varchar(20) not null,
    name         varchar(50) not null,
...
comment on table develop.mapping is '平台资源';
comment on column develop.mapping.context_path is '服务名称';
comment on column develop.mapping.name is '名称';
comment on column develop.mapping.type is '类型';
comment on column develop.mapping.value is '路径';
comment on column develop.mapping.insert_time is '创建时间';
comment on column develop.mapping.update_time is '更新时间';
alter table develop.mapping owner to postgres;

create table if not exists develop.mapping_member
(
    id          bigserial primary key,
    member_id bigint not null,
    mapping_id bigint not null
);
comment on table develop.mapping_member is '管理员与平台资源关联';
comment on column develop.mapping_member.member_id is '管理员ID';
comment on column develop.mapping_member.mapping_id is '平台资源ID';
alter table develop.mapping_member owner to postgres;
